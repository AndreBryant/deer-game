...
<div
	class="flex w-full flex-col rounded-lg bg-slate-950 bg-opacity-60 py-4 transition-all hover:bg-opacity-50"
...
>
	{#if !isCollapsed}
		<h3 class="text-md mb-2 pl-2"><ChevronDown class="mr-2 inline" />Players</h3>
		<hr class="opacity-50" />
	...
	{:else}
		<h3 class="text-md pl-2"><ChevronUp class="mr-2 inline" />Players</h3>
	{/if}
</div>
